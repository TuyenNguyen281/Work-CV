...
<c:if test="${login_message_success != null}">
...
<c:if test="${login_message_fail !=null}">
    <div class="toast" data-delay="2000" style="position:fixed;top: 100PX; right: 10PX;z-index: 2000;width: 300px">
        <script>
            swal({
...
<section class="ftco-section">
    <div class="container">
        ...
        <div class="row">
            <c:forEach var="topCategory" items="${listTopCategory}">
                <div class="col-md-3 ">
                    <ul class="category text-center">
                        <li><a style="text-decoration: none !important;"
                               href="/home/list-job/${topCategory.category.id}/1"><p>${topCategory.category.name}</p>
                            <span class="number">${topCategory.rank}</span> <span>Vị trí</span><i
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 pr-lg-5">
                ...
                <div class="row">
                    <c:forEach var="recruitment" items="${listTopRecruitment}">
                        <div class="col-md-12 ">
                            <div class="job-post-item p-4 d-block d-lg-flex align-items-center">
                                <div class="one-third mb-4 mb-md-0">
                                    <div class="job-post-item-header align-items-center">
                                        <span class="subadge">${recruitment.recruitment.type}</span>
                                        <h2 class="mr-3 text-black"><a
                                                href="/home/recruitment/detail/${recruitment.recruitment.id}">${recruitment.recruitment.title}</a>
                                        </h2>
                                    </div>
                                    <div class="job-post-item-body d-block d-md-flex">
                                        <div class="mr-3"><span class="icon-layers"></span> <a
                                                href="#">${recruitment.recruitment.company.nameCompany}</a>
                                        </div>
                                        <div><span
                                                class="icon-my_location"></span><span>${recruitment.recruitment.address}</span>
                                        </div>
                                    </div>
                                </div>
                                <security:authorize access="!hasRole('CTY')">
                                <div class="one-forth ml-auto d-flex align-items-center mt-4 md-md-0">
                                    <div>
                                        <a onclick="saveJob(${recruitment.recruitment.id})"
                                           class="icon text-center d-flex justify-content-center align-items-center icon mr-2">
                                            <span class="icon-heart"></span>
                                        </a>
                                    </div>
                                    <a data-toggle="modal" data-target="${'#exampleModal'}${recruitment.recruitment.id}"
                        ...
                        <!-- end -->
                        <!-- Modal -->
                        <div class="modal fade" id="${'exampleModal'}${recruitment.recruitment.id}" tabindex="-1"
                             role="dialog"
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Ứng tuyển:
                                            <span>${recruitment.recruitment.title}</span></h5>
                                    ...
                                    <form method="post" action="/UCV/apply-job">
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <select id="${'choose'}${recruitment.recruitment.id}"
                                                            onchange="choosed(${recruitment.recruitment.id})"
                                                ...
                                                <div id="${'loai1'}${recruitment.recruitment.id}" style="display:none"
                                                     class="col-12">
                                                    <label
                                                            class="col-form-label">Giới thiệu:</label>
                                                    <textarea rows="10" cols="3" class="form-control"
                                                              id="${'text1'}${recruitment.recruitment.id}">

                                                    </textarea>
                                                </div>
                                                <div id="${'loai2'}${recruitment.recruitment.id}" style="display:none"
                                                     class="col-12">

                                                    <label
                                                            class="col-form-label">Chọn cv:</label>
                                                    <input type="file" class="form-control"
                                                           id="${'fileUpload'}${recruitment.recruitment.id}" name="file"
                                                           required accept=".pdf" onchange="checkPdfFile(this)">
                                                    <label
                                                            class="col-form-label">Giới thiệu:</label>
                                                    <textarea rows="10" cols="3" class="form-control"
                                                              id="${'text2'}${recruitment.recruitment.id}">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" id="${'button1'}${recruitment.recruitment.id}"
                                                        style="display: none"
                                                        onclick="apply1(${recruitment.recruitment.id} )"
                                                        class="btn btn-primary">Nộp
                                                </button>
                                                <button type="button" id="${'button2'}${recruitment.recruitment.id}"
                                                        style="display: none"
                                                        onclick="apply2(${recruitment.recruitment.id})"
                                                        class="btn btn-primary">Nộp
                                                </button>
                                            </div>
                                        </div>
            ...
            <div class="col-lg-3 sidebar">
                ...
                <c:forEach var="topCompany" items="${listTopCompany}">
                    <div class="sidebar-box">
                        <div class="">
                            <a href="/home/detail-company/${topCompany.company.id}/1" class="company-wrap"><img
                                    height="200" width="200"
                                    src="${topCompany.company.logo}" class="img-fluid" alt="Colorlib Free Template"></a>
                            <div class="text p-3">
                                <h3><a href="'/home/detail-company/${topCompany.company.id}/1"></a></h3>
                                <p><span class="number" style="color: black">${topCompany.rank}</span> <span><a
                                        href="/home/detail-company/${topCompany.company.id}/1">Vị trí ứng tuyển</a></span>
                                </p>
                            </div>
                        </div>
                    </div>
