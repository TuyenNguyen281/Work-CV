        ...
        <div class="row no-gutters slider-text align-items-end justify-content-start">
            <div class="col-md-12 text-center mb-5">
                <p class="breadcrumbs mb-0"><span class="mr-3"><a href="/">Trang chủ <i
                        class="ion-ios-arrow-forward"></i></a></span>Hot job <span></span></p>
                <h1 class="mb-3 bread">Danh sách các công việc</h1>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-12 pr-lg-4">
                <div class="row">
                    <div class="row form-group">
                        <h3>Danh sách các công việc: ${category.name}</h3>
                    </div>
                        ...
                        <div class="block-27">
                            <ul>
                                <c:if test="${pageNumber > 1}">
                                    <li><a href="/home/list-job/${category.id}/${pageNumber -1}">&lt;</a></li>
                                </c:if>
                                <li><a href="/home/list-job/${category.id}/${pageNumber}">${pageNumber}</a></li>
