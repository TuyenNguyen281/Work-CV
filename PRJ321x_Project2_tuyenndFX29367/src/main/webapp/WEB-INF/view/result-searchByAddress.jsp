                        ...
                        <div class="block-27">
                            <ul>
                                <c:if test="${pageNumber > 1}">
                                    <li>
                                        <a href="/home/recruitment/searchByAddress/${pageNumber -1}?keySearch=${keySearch}">&lt;</a>
                                    </li>
                                </c:if>
                                <li>
                                    <a href="/home/recruitment/searchByAddress/${pageNumber}?keySearch=${keySearch}">${pageNumber}</a>
                                </li>
