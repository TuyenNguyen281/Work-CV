            ...
            <ul class="navbar-nav ml-auto">
                ...
                <security:authorize access="isAuthenticated()">
                    ...
                    <security:authorize access="hasRole('UCV')">
                        <li class="nav-item cta mr-md-1"><a href="/UCV/list-saveJob/1" class="nav-link">Công việc đã
                            lưu</a></li>
                        <li class="nav-item cta mr-md-1"><a href="/UCV/list-applyJob/1" class="nav-link">Công việc đã
                            ứng tuyển</a></li>
                        <li class="nav-item cta mr-md-1"><a href="/UCV/list-companyFollow/1" class="nav-link">Công ty đã
                            theo dõi</a></li>
                        <li class="nav-item cta mr-md-1 dropdown">
                        ...
                        <div class="block-27">
                            <ul>
                                <c:if test="${pageNumber > 1}">
                                    <li>
                                        <a href="/home/recruitment/searchByCategory/${pageNumber -1}?keySearch=${keySearch}">&lt;</a>
                                    </li>
                                </c:if>
                                <li>
                                    <a href="/home/recruitment/searchByCategory/${pageNumber}?keySearch=${keySearch}">${pageNumber}</a>
                                </li>
